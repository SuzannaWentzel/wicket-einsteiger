...
public class JQueryUiJsResourceReference extends PackageResourceReference
{
	...
	public JQueryUiJsResourceReference() { super(JQueryUiJsResourceReference.class, "jquery-ui.min.js"); }

	public static JQueryUiJsResourceReference get() { return INSTANCE; }
